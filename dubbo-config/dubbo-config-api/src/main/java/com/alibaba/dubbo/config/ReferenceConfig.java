...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    private void init() {
        ...
        // 以上这段代码主要用于检测 ConsumerConfig 实例是否存在，
        // 如不存在则创建一个新的实例，然后通过系统变量或 dubbo.properties 配置文件填充 ConsumerConfig 的字段。
        ...
        // 以上代码用于从系统属性或配置文件中加载与接口名相对应的配置，并将解析结果赋值给 url 字段。url 字段的作用一般是用于点对点调用。
        // -------------------------------分割线2------------------------------
        ...
        // 以上代码用于检测几个核心配置类是否为空，为空则尝试从其他配置类中获取
        // -------------------------------分割线3------------------------------
        ...
        // 以上代码用于处理 MethodConfig 实例。该实例包含了事件通知配置，比如 onreturn、onthrow、oninvoke 等
        // ------------------------------- 分割线5 ------------------------------
        ...
        // 以上代码主要用于解析服务消费者 ip，以及调用 createProxy 创建代理对象
    }
    ...
    private T createProxy(Map<String, String> map) {
        ...
        if (isJvmRefer) {
            ...
            // 直接使用injvm协议在内存中构建 InjvmInvoker 实例
